...
if(isset($_POST['get'])){
  require "config.php";
    ...
    $telp = $_POST['telp'];
    $pass = $_POST['pass'];
    $result = mysqli_query($conn, "UPDATE login SET nama_kasir='$nama_kasir', user='$user',pass='$pass',nama_toko='$toko',alamat='$alamat',telp='$telp'
            ...
            <div class="card-body">
                ...
                <fieldset>
                  ...
                  <input type="hidden" name="id_login" value="<?php echo $id;?>">
                    ...
                    <label class="col-sm-4 col-form-label"><b>Nama Kasir :</b></label>
                    <div class="col-sm-8 mb-2">
                      <input type="text" name="nama_kasir" class="form-control" value="<?php echo $nama_kasir;?>" required>
                    </div>
