...
while ($r = $query->fetch_assoc()) {
    $harga_barang = (float) $r['harga_barang']; // Ubah ke tipe data float
    $quantity = (int) $r['quantity']; // Ubah ke tipe data integer

    $total = $harga_barang * $quantity;
    $tot_bayar += $total;
    $bayar = (float) $r['bayar']; // Ubah ke tipe data float
  ...
  <div class="col-md-6 mb-3">
      ...
      while($dat2 = mysqli_fetch_array($notrans)){
        ...
        echo "$notransaksi";
          ...
          ?></li>
                    <li>KASIR : <?php echo $nama_kasir ?></li>
                </ul>
              </div>
